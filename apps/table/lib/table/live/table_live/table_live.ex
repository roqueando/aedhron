defmodule Table.TableLive do
  ...
  def handle_event("open_modal", _value, socket) do
    send_update Table.Components.Modal, id: "modal-create", state: :open
    {:noreply, socket}
  end
  ...
  def handle_event("create_table", %{"table" => table_params}, socket) do
    ...
    send_update Table.Components.Modal, id: "modal-create", link: url, room_name: "#{table.name}@#{table.id}"
    {:noreply, socket}
  end
end
